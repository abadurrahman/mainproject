...
{   
    ...
    public function store(Request $request)
    {
        ...
        $data['fotter_slider']=$request->fotter_slider;
    	$data['status']=1;
        ...
        if($image_one && $image_two && $image_three){
            $image_one_name= hexdec(uniqid()).'.'.$image_one->getClientOriginalExtension();
                Image::make($image_one)->resize(230,300)->save('backend/slider/'.$image_one_name);
                $data['image_one']='backend/slider/'.$image_one_name;   

            $image_two_name= hexdec(uniqid()).'.'.$image_two->getClientOriginalExtension();
                Image::make($image_two)->resize(230,300)->save('backend/slider/'.$image_two_name);
                $data['image_two']='backend/slider/'.$image_two_name; 

            $image_three_name= hexdec(uniqid()).'.'.$image_three->getClientOriginalExtension();
                Image::make($image_three)->resize(230,300)->save('backend/slider/'.$image_three_name);
                $data['image_three']='backend/slider/'.$image_three_name; 
     ...
     public function UpdateSliderWithPhoto(Request $request,$id)
    {
       ...
       // $data['image_one']=$request->image_one;
        ...
        if($request->has('image_one')) {
           unlink($old_one);
           $image_one_name= hexdec(uniqid()).'.'.$image_one->getClientOriginalExtension();
           Image::make($image_one)->resize(300,300)->save('backend/slider/'.$image_one_name);
           $data['image_one']='backend/slider/'.$image_one_name;
