          ...
          <div class="row">
            <div class="card-body">
                <div class="card-header">
                    ...
                    <a href="{{ route('add.category') }}" style="margin-top:-25px; " class="btn btn-sm btn-primary float-right">Add-Category</a>
                </div>
                    ...
                    <table class="table table-flush" style="width: 100%;" id="datatable-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info" href="{{ URL::to('edit/category/'.$row->id) }}">Edit</a>
