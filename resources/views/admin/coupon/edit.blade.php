       ...
       <form action="{{ url('update/coupon/'.$coupon->id) }}" method="POST">
            ...
            <div class="pl-lg-4">
              ...
              <div class="form-group">
                <label class="form-control-label" for="example3cols1Input">Coupon Code*</label>
                <input type="text" class="form-control" id="example3cols1Input" placeholder="Name" name="coupon" value="{{ $coupon->coupon }}">
              </div>
            </div>  
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-control-label" for="example3cols1Input">Discount*</label>
                <input type="text" class="form-control" id="example3cols1Input" placeholder="discount" name="discount" value="{{ $coupon->discount }}">
              </div>
            </div> 
