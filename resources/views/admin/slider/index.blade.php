          ...
          <div class="row">
            <div class="card-body">
                <div class="card-header">
                    ...
                    <a href="{{ route('add.slider') }}" style="margin-top:-25px; " class="btn btn-sm btn-primary float-right">Add-Slider</a>
                </div>
                            ...
                            <tr>
                              ...
                              <td>
                               ...
                               @else
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info" href="{{ URL::to('edit/slider/'.$row->id) }}"><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-sm btn-danger" id="delete" href="{{ URL::to('delete/slider/'.$row->id) }}"><i class="fa fa-trash"></i></a>
                                    <a class="btn btn-sm btn-warning" href="{{ URL::to('view/slider/'.$row->id) }}"><i class="fa fa-eye"></i></a>
