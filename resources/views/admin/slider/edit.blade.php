...
<div style="padding:25px;margin-top:-5.5rem">
  <div class="card mb-4">
        ...
        <!-- Card body -->
        <div class="card-body">
        <form method="POST" action="{{ url('update/slider/withoutphoto/'.$slider->id) }}" enctype="multipart/form-data">
          @csrf
         ...
         <div class="row">
          <div class="col-md-4" >
              <div class="form-group">
               ...
               <input class="custom-control-input" id="customCheck1" type="checkbox" name="main_slider_one" value="1" <?php if ($slider->main_slider_one == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck2" type="checkbox" name="main_slider_two" value="1" <?php if ($slider->main_slider_two == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck3" type="checkbox" name="mens_slider_one" value="1" <?php if ($slider->mens_slider_one == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck4" type="checkbox" name="mens_slider_two" value="1" <?php if ($slider->mens_slider_two == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck5" type="checkbox" name="womens_slider_one" value="1" <?php if ($slider->womens_slider_one == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck6" type="checkbox" name="womens_slider_two" value="1" <?php if ($slider->womens_slider_two == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck8" type="checkbox" name="electronics_slider" value="1" <?php if ($slider->electronics_slider == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4">
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck9" type="checkbox" name="blog_slider" value="1" <?php if ($slider->blog_slider == 1) {
              echo "checked";
            }?>>
           ...
           <div class="col-md-4">
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck10" type="checkbox" name="contact_slider" value="1" <?php if ($slider->contact_slider == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4">
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck11" type="checkbox" name="fotter_slider" value="1" <?php if ($slider->fotter_slider == 1) {
              echo "checked";
            }?>>
...
<div style="padding:25px;margin-top:-1.5rem">
  <div class="card mb-4">
        ...
        <!-- Card body -->
        <div class="card-body">
        <form method="POST" action="{{ url('update/slider/withphoto/'.$slider->id) }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <img src="{{ URL::to($slider->image_one) }}" id="one" style="margin-top:25px; height: 70px;width: 60px;">        
               </div>
            </div>  
            ...
            <div class="col-md-6">
              <div class="form-group">
                <img src="{{ URL::to($slider->image_two) }}" id="one" style="margin-top:25px; height: 70px;width: 60px;">        
               </div>
            </div> 
            ...
            <div class="col-md-6">
              <div class="form-group">
                <img src="{{ URL::to($slider->image_three) }}" id="one" style="margin-top:25px; height: 70px;width: 60px;">        
               </div>
            </div> 
         </div>  
          <button class="btn btn-primary" style="margin-top:15px;" type="submit">Save Slider</button>
