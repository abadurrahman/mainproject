...
<div class="row">
    ...
    <div class="col-xl-3 order-xl-1">
      <div class="card">
        ...
        <div class="card-body">
        <form action="{{ route('header-advertise.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="pl-lg-4">
              <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="source_link" name="source_link" class="form-control @error('source_link') is-invalid @enderror" value="{{ old('source_link') }}" placeholder="Reference Link">
                        @error('source_link')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="show_days" name="show_days" class="form-control @error('show_days') is-invalid @enderror" value="{{ old('show_days') }}" placeholder="how Days">
                        @error('show_days')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="col-lg-12">
                      <div class="custom-file">
                        <input type="file" id="image" name="image" class="custom-file-input @error('show_days') is-invalid @enderror" value="{{ old('image') }}" id="customFileLang" lang="en">
