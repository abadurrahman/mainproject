        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">SubCategory</h6>
       ...
       <form action="{{ url('update/subcategory/'.$subcategory->id) }}" method="POST">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="example3cols1Input" placeholder="Name" name="subcategory_name" value="{{ $subcategory->subcategory_name }}">
              </div>
            </div>  
         ...
         <div class="row">
          <div class="col-md-4" >
              <div class="form-group">
               ...
               <input class="custom-control-input" id="customCheck1" type="checkbox" name="subcat_1" value="1" <?php if ($subcategory->subcat_1 == 1) {
              echo "checked";
            }?>>
          ...
          <div class="col-md-4" >
              <div class="form-group">
                <div class="custom-control custom-checkbox mb-3">
               <input class="custom-control-input" id="customCheck2" type="checkbox" name="subcat_2" value="1" <?php if ($subcategory->subcat_2 == 1) {
              echo "checked";
            }?>>
