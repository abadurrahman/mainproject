...
<div style="padding:25px;margin-top:-5.5rem">
  <div class="card mb-4">
        ...
        <!-- Card body -->
        <div class="card-body">
        <form method="POST" action="{{ route('store.websetting') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label" >Phone One:</label>
                  <input type="text" class="form-control" placeholder="Phone" name="phone_one" required="">
                </div>
             </div>
             <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label" >Phone Two:</label>
                  <input type="text" class="form-control" placeholder="Phone" name="phone_two">
                </div>
             </div>
           ...
           <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="file" class="form-control" id="example3cols1Input" name="logo" onchange="readURL(this);" required="" accept="image"> 
                <img src="#" id="one" style="margin-top:25px;" >             
              </div>
            </div> 
         </div>
          <button class="btn btn-primary" style="margin-top:15px;" type="submit">Save Setting</button>
        </form>  
        </div>
    </div>
</div>
