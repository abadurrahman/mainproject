...
<br><br><br>
			...
			<div class="table-responsive cart_info">
				...
				<button type="" class="btn btn-danger" style="margin-bottom: 40px;"><a href="{{ route('payment.step') }}" style="color: #fff; " class="button cart_button_checkout">Final Step</a></button>
